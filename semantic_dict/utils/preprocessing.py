...
_ABBREV = {
    ...
    # Регионы — разворачиваем, чтобы ловить «Москва», «регион» и т.д.
    r"\bмо\b":                "московский область регион",
    r"\bспб\b":               "санкт петербург город",
    r"\bмск\b":               "москва город",
    r"\bдфо\b":               "дальний восток округ",
    r"\bсфо\b":               "сибирь округ регион",
    r"\bцфо\b":               "центральный округ регион",
}
